  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      <div className="flex flex-col items-center mb-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Registrasi Mahasiswa</h1>
        <p className="text-sm text-gray-500">Buat akun untuk mengelola magang Anda</p>
      </div>
      ...
      <div className="bg-white border border-gray-100 rounded-3xl p-8 max-w-lg w-full shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-sm font-semibold text-gray-700 block mb-1">Email IPB</label>
            <input
              type="email"
              required
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:bg-white transition-all"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="text-sm font-semibold text-gray-700 block mb-1">NIM</label>
              <input
                type="text"
                required
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:bg-white transition-all"
            ...
            <div>
              <label className="text-sm font-semibold text-gray-700 block mb-1">Fakultas</label>
              <input
                type="text"
                required
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:bg-white transition-all"
          ...
          <div>
            <label className="text-sm font-semibold text-gray-700 block mb-1">Program Studi</label>
            <input
              type="text"
              required
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-indigo-500 focus:bg-white transition-all"
